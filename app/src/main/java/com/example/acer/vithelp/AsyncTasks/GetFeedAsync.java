...
import com.example.acer.vithelp.LoginActivity;
...
public class GetFeedAsync extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... voids) {
        String view_URL = "https://841ed852.ngrok.io/feedback";
        URL url = createUrl(view_URL);

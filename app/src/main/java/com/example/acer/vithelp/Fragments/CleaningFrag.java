...
public class CleaningFrag extends Fragment {
    ...
    private ArrayList<FeedbackWord> ExtractFeaturesFromJson(String jsonresponse) {
        ...
        ArrayList<FeedbackWord> clean = new ArrayList<FeedbackWord>();
        ...
        try {
            ...
            for (int i = 0; i < feedback.length(); i++) {
                ...
                if(prob.equals("Cleaning")) {
                    clean.add(new FeedbackWord(id, prob, date, time, type, blty, block, des, pr));
                }
            }
            return clean;

...
public class SetProgressAsync extends AsyncTask<JSONObject,Void,String>{
    ...
    protected String doInBackground(JSONObject... params) {
        ...
        String ADD_URL = "https://841ed852.ngrok.io/setprog";
    ...
    private String makeHttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e("Error", "Problem Adding new Feedback.", e);
        } finally {
